...
const infrastructureStack = new pulumi.StackReference('organization/tpf-infrastructure/dev')

const port = infrastructureStack.getOutput('port').apply((port: number) => port)
const endpoint = infrastructureStack.getOutput('endpoint').apply((endpoint: string) => endpoint)
const dbUser = infrastructureStack.getOutput('dbUser').apply((dbUser: string) => dbUser)
const dbPassword = infrastructureStack.getOutput('dbPassword').apply((dbPassword: string) => dbPassword)
